...
var consol    = require('consolidate');
...
function Master( config ) {
  ...
  function initRoutes() {
    ...
    app.get('/', function(request, response) {
      response.render('master/index', {
        i18n_master_running: i18n('Master running on %s:%s', hostname, port),
    ...
    app.get('/capture', function(request, response) {
      response.render('master/capture', {
