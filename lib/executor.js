...
Executor.prototype.printResults = function(result) {
  var Reporter = require('./reporters/default').Default,
  ...
  reporter.emit('suite', this.getFriendlyBrowserName(result.userAgent));
  ...
  reporter.emit('suite_end', result.done.runtime);
