...
Executor.prototype.initRoutes = function() {
  ...
  app.get('/test/runner/:testid', function(request, response) {
  ...
  /** Serves sandbox page, which will run the test cases via an iframe **/
  app.get('/test/:testid', function(request, response) {
    ...
    sandboxTemplate = config.instance().loadTemplate('sandbox/default');
