 ...
 * @param {number} startingPort the port which is initially defined
 * @return {promise}
 */
Executor.prototype.removeExistingTests = function(startingPort) {
  var tempRoot = this.venusTemp('test'),
      def = deferred();
