...
Executor.prototype.createSauceLabsRunners = function(options) {
  var server      = options.sauceLabsServer   || 'ondemand.saucelabs.com',
      browserName = options.sauceLabsBrowser  || 'firefox',
      version     = options.sauceLabsVersion  || '20',
      platform    = options.sauceLabsPlatform || 'OS X 10.6',
      username    = options.username          || 'venusjs',
      accessKey   = options.accessKey         || '0b0302b9-36ed-430d-8665-e9d84c8a42cf';
