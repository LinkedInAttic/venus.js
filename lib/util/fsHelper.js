 ...
 * @param {array} results - the accumulator (list of paths of the found files)
 *
 * @returns {array} results - the list of paths of the found files
 */
 ...
 *
 * @param {array} paths - an array of all potential paths
 *
